<p align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=900&duration=3000&pause=1000&color=38A6F7&center=true&vCenter=true&width=600&lines=Hola%2C+soy+Jose+Gonzalez+👋" alt="Typing SVG" />
  </a>
</p>

<br>
	
## <picture><img src = "https://github.com/7oSkaaa/7oSkaaa/blob/main/Images/about_me.gif?raw=true" width = 40px></picture> Acerca de mi

<picture> <img align="right" src="https://github.com/7oSkaaa/7oSkaaa/blob/main/Images/Right_Side.gif?raw=true" width = 250px></picture>

<br><br>
💻 Técnico Informático enfocado en soporte, redes y administracion basica de servidores.

🛠️ Experiencia con Python, Bash, configuración de redes y servidores.

📈 Busco aprender nuevas tecnologías y mejorar mis habilidades. Actualmente me estoy 
    enfocando en desarrollo backend, automatización e infraestructura IT.

🚀 Abierto a nuevas oportunidades donde pueda apoyar, seguir creciendo y enfrentar 
    nuevos desafíos.
